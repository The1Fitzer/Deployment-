...
<div class="panel">
					   <div class="panel-wrapper">
                            ...
                            <?php foreach($youtube2 as $val2){ 
										echo "<td><a class='video' href='http://www.youtube.com/v/$val2?fs=1&amp;autoplay=1'><img id='$va2' src='http://img.youtube.com/vi/$val2/0.jpg' height='150px' width='200px'/></a></td>";
									}
							?>
							</tr>
							</table>
